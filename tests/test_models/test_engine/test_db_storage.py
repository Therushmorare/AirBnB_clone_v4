...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        newState.save()
        newUser = User(email="cocomelon@foobar.com", password="password")
        newUser.save()
        self.assertIs(newState, models.storage.get("State", newState.id))
        self.assertIs(None, models.storage.get("State", "Compton"))
        self.assertIs(None, models.storage.get("State", "Long Beach"))
    ...
    def test_count(self):
        ...
        newState = State(name="Santa Monica")
        newState.save()
        newUser = User(email="Kendrick@gmail.com.com", password="pglangfool")
        newUser.save()
